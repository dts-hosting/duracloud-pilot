...
- [Developer Guidelines](.junie/guidelines.md) - Detailed information for developers working on the project
...
For detailed build and configuration instructions, see the [Developer Guidelines](.junie/guidelines.md).
...
For detailed information about testing, debugging, and development practices, see the [Developer Guidelines](.junie/guidelines.md).
